...
console.log("Vasiliy Kandinskiy");
...
function get20s(array) {
  let filteredArray = [];
  for(let i=0; i< artists.length;i++){
    const myArr = artists[i].years.split("-");
    if ((myArr[0] >=1900) && (myArr[1] <=2000)){
...
function addArtist(array) {
  array.push({ 
    id: 20,
    name: "Caleb Postlewait", 
    years: "2003-2021",
    genre: "Web Design", 
    nationality: "Asian-American",
    bio: "This is a random sentence, it doesnt matter what i put here"
  }  )
  return array;
}
